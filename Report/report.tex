...
%%%%%%%%摘要
\begin{empAbstract}
本实验利用基于 4F 结构的光学系统，系统研究了傅里叶光学的基本原理及其在信息处理中的应用。通过观察一维光栅（$12\ \textrm{mm}^{-1}$）和二维正交光栅（“光”字屏）的夫琅禾费衍射图样，直观验证了会聚透镜的傅里叶变换性质，频谱面上的空间频率分布与物函数的周期和方向严格对应；利用自制滤波器（小孔、挡板、狭缝）实现了空间滤波，包括低通（图像模糊）、高通（边缘增强）及方向滤波（特定纹理提取）；通过复合光栅滤波器（$f_1=100\ \textrm{mm}^{-1}$, $f_2=102\ \textrm{mm}^{-1}$）观察到光学微分效应，突出了图像边缘；实验还通过两个卷积件的复合衍射，在频域验证了卷积定理；最后，利用 $\theta$ 调制片和白光光源实现了假彩色编码。实验结果直观地展示了在空间频域中处理信息的有效性，为光学计算和现代成像技术提供了实验基础。
\end{empAbstract}
...
\subsection{空间成分滤波}
使用一维光栅（$12\ \textrm{mm}^{-1}$），条纹沿竖直方向放置，构建物面光场。在频谱面 $F$ 处预期可观察到水平排列的衍射图样，也即物面光场的空间频率分布。
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-baseline.pdf}
        \subcaption{不加滤波器}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-0_pm1_only.pdf}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-0_pm2_only.pdf}
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-0_pm1_pm2_only.pdf}
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-0_only.pdf}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/001/10_per_mm-0_excluded.pdf}
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/002/2dim_baseline_02.pdf}
        \subcaption{不加滤波器}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/002/2dim_horizontal.pdf}
        \subcaption{仅允许水平频率}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/002/2dim_vertical.pdf}
        \subcaption{仅允许竖直频率}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/002/2dim_plus45.pdf}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/002/2dim_minus45.pdf}
        \subcaption{仅允许 $-45^\circ$ 方向}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Data/003-pattern/conv_base_1.pdf}
        \subcaption{卷积件1}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Data/003-pattern/conv_base_2.pdf}
        \subcaption{卷积件2}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Data/003-pattern/conv_344_164.pdf}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_344_164.pdf}
        \subcaption{$+0^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_014_164.pdf}
        \subcaption{$+30^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_029_164.pdf}
        \subcaption{$+45^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_044_164.pdf}
        \subcaption{$+60^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_074_164.pdf}
        \subcaption{$+90^\circ$}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_344_194.pdf}
        \subcaption{$+30^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_344_209.pdf}
        \subcaption{$+45^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_344_224.pdf}
        \subcaption{$+60^\circ$}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_344_254.pdf}
        \subcaption{$+90^\circ$}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_014_194.pdf}
        \subcaption{$+30^\circ$}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_029_209.pdf}
        \subcaption{$+45^\circ$}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Data/003-pattern/conv_044_224.pdf}
        \subcaption{$+60^\circ$}
...
% 插入单张Data/003-pattern/differential.pdf
\begin{figure*}
    \centering
    \includegraphics[width=0.8\linewidth]{Data/003-pattern/differential.pdf}
    \captionnamefont{\wuhao\bf\heiti}
    \captiontitlefont{\wuhao\bf\heiti}
    \caption{光学微分实验结果图}
...
% Data/pseudo_colour.pdf为调制结果
% Data/theta-modulation_diff_pattern.pdf为频谱面衍射图样
\begin{figure*}
    \centering
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Data/005-theta/pseudo_colour.pdf}
        \subcaption{像面彩色图像}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Data/005-theta/theta-modulation_diff_pattern.pdf}
        \subcaption{频谱面衍射图样}
